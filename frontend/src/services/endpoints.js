...
export const endpoints = {
  ...
  courses: {
    ...
    submissions: (assignmentId) => `/api/courses/assignments/${assignmentId}/submissions/`,
    submissionDetail: (assignmentId, subId) => `/api/courses/assignments/${assignmentId}/submissions/${subId}/`,
